        ...
        <div className="container">
          ...
          <div className="join-card">
            ...
            <form className="signup-form" onSubmit={handleSubmit}>
              ...
              <button 
                type="submit" 
                className="btn-primary hover-lift gradient-animate"
                disabled={isLoading}
              >
                {isLoading ? (
            ...
            <div className="social-signup stagger-children">
              <button className="social-btn google-btn hover-lift-small" disabled>
