...
function VerifyPageContent() {
  ...
  const handleVerification = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/auth/verify', {
        ...
        body: JSON.stringify({
          userId, // This can be null, the API will find user by verification code
  ...
  if (!userId) {
    // If no userId provided, show a generic verification form
    return (
      <>
                ...
                <>
                  ...
                  <div className="verification-help">
                    ...
                    <div className="card-actions" style={{ marginTop: '1rem' }}>
                      <Link href="/join" className="btn-secondary">Create New Account</Link>
